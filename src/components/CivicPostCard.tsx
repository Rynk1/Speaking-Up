          ...
          >
            {post.userFollowed ? (
              <>
                ...
                <span>Following Issue ({formatCount(post.engagement?.followersCount || post.followersCount || 0)})</span>
              </>
            ) : (
              <>
                <BellPlus className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" />
                <span>Follow Issue ({formatCount(post.engagement?.followersCount || post.followersCount || 0)})</span>
              </>
            )}
          </button>
