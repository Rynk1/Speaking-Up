...
export const CivicPostCard: React.FC<CivicPostCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between pb-2 border-b border-slate-200 dark:border-slate-800/80 text-[11px]">
        <div className="flex items-center gap-1.5 text-emerald-600 dark:text-emerald-400 font-medium">
          <span className="w-2 h-2 rounded-full bg-emerald-500 animate-pulse"></span>
          <span>Community Megaphone Discovery</span>
          <span className="text-slate-500 dark:text-slate-400 text-[10px] hidden sm:inline">• Zero User Followers Needed</span>
        </div>
      ...
      <div className="pt-2 border-t border-slate-200 dark:border-slate-800 flex flex-wrap items-center justify-between gap-2">
        ...
        >
          <CheckCircle2 className={`w-4 h-4 ${post.userConfirmed ? 'text-white' : 'text-emerald-600 dark:text-emerald-400'}`} />
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          <button
            ...
            className="px-2.5 py-1.5 bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded-xl border border-slate-300 dark:border-slate-700 flex items-center gap-1.5 transition-colors"
          ...
          <button
            ...
            className="px-3 py-1.5 bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs font-semibold rounded-xl border border-slate-300 dark:border-slate-700 flex items-center gap-1.5 transition-colors"
            title="Share to WhatsApp, X, Facebook or Telegram"
          >
            <Share2 className="w-3.5 h-3.5 text-amber-600 dark:text-amber-400" />
            <span>Share</span>
            <span className="text-[11px] text-slate-500 dark:text-slate-400">{post.engagement.shares}</span>
          </button>
          ...
          <button
            ...
            className={`p-2 rounded-xl text-xs border transition-colors ${
              post.userReposted
                ...
                : 'bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-400 border-slate-300 dark:border-slate-700'
            }`}
          ...
          <button
            ...
            className="px-2.5 py-1.5 bg-slate-100 dark:bg-slate-800/80 hover:bg-slate-200 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 text-xs rounded-xl border border-slate-300 dark:border-slate-700 flex items-center gap-1.5 transition-colors"
          >
