  ...
  return (
    <div className="max-w-7xl mx-auto p-4 md:p-6 space-y-6">
      <div className="flex items-center space-x-3 border-b border-gray-200 dark:border-gray-800 pb-4">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">P³RE Privacy Review Portal</h1>
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Human moderation queue for reviewing flagged PII findings, contextual allegations, and public projections.
          </p>
        </div>
      </div>
